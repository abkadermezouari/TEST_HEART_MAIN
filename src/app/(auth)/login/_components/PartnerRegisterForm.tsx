...
import { registerPartnerAction } from "../_actions/partner-register.action";
...
export function PartnerRegisterForm() {
  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit} noValidate>
      <div>
        <label className="block text-xs font-semibold text-[#6f797a] mb-2" htmlFor="partner-reg-fullname">
          Prénom &amp; Nom
        </label>
        <input
          id="partner-reg-fullname"
          name="full_name"
          type="text"
          required
          autoComplete="name"
      ...
      <div>
        <label className="block text-xs font-semibold text-[#6f797a] mb-2" htmlFor="partner-reg-storename">
          Nom de votre magasin
        </label>
        <input
          id="partner-reg-storename"
          name="store_name"
          type="text"
          required
      ...
      <div>
        <label className="block text-xs font-semibold text-[#6f797a] mb-2" htmlFor="partner-reg-email">
          Email professionnel
        </label>
        <input
      ...
      <div>
        <label className="block text-xs font-semibold text-[#6f797a] mb-2" htmlFor="partner-reg-password">
          Mot de passe
        </label>
        <input
      ...
      >
        {isPending ? "Création du compte…" : "Créer mon compte partenaire"}
      </button>
    </form>
  );
}
